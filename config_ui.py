...
from pystart.ui_utils import CommonDialog, MappingCombobox, create_url_label, ems_to_pixels
...
class ConfigurationPage(ttk.Frame):
    ...
    def add_checkbox(
        ...
        warnings.warn(
            "Consider using pystart.config_ui.add_option_checkbox instead", DeprecationWarning
        )
    ...
    def add_combobox(
        ...
        warnings.warn(
            "Consider using pystart.config_ui.add_option_combobox instead", DeprecationWarning
        )
    ...
    def add_entry(self, option_name, row=None, column=0, pady=0, padx=0, columnspan=1, **kw):
        warnings.warn(
            "Consider using pystart.config_ui.add_option_entry instead", DeprecationWarning
        )
