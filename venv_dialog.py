...
from pystart.misc_utils import inside_flatpak, running_on_windows
from pystart.ui_utils import MappingCombobox, askdirectory, askopenfilename
...
class VenvDialog(SubprocessDialog):
    ...
    def populate_main_frame(self):
        ...
        from pystart.plugins.cpython_frontend.cp_front import find_local_cpython_executables
