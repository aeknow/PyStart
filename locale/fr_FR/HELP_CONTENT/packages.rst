...
PyStart a deux options pour l'installation de paquets de tierces parties.
...
La distribution Python qui vient avec PyStart ne contient pas de bibliothèques de programmation scientifique
...
avec pip mais au cas où il y a des problèmes, vous pouvez utiliser PyStart avec une distribution
...
d'une version 32-bits avec un très vieux système). **Notez que PyStart ne supporte que Python3, assurez-vous bien de choisir la version pour Python 3 d'Ananconda**.
...
Dans PyStart ouvrez « Outils » et sélectionnez « Options ... ». Dans le dialogue d'options ouvrez l'onglet « Interpréteur »,
