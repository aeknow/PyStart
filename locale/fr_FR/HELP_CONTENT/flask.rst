...
mais ça peut intimider certains débutants. PyStart essaie de rendre les choses plus faciles et permet de lancer les programmes Flask
...
PyStart lancera le serveur de développement approximativement comme ceci :
...
``threaded=False`` est utilisé car le débogueur de PyStart ne supporte que les programmes à un seul fil (thread),
...
Dans ce cas PyStart n'ajoutera rien à votre code.
