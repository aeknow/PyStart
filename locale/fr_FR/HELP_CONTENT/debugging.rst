...
qui est plus confortable dans la plupart des cas. Elle s'appelle **avancer pas-à-pas dans le code** et c'est le pain béni de PyStart. Allez au chapitre `Utilisation des débogueurs <debuggers.rst>`_ pour en apprendre plus.
