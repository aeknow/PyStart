...
Se você acidentalmente deu um grande passo e passou por cima de um trecho de código interessante, você pode **voltar o passo** selecionando *Executar → Voltar*. O PyStart mostrará o estado do programa como estava antes da última etapa. Agora você pode continuar com pequenos passos e ampliar este pedaço de código. (Como funciona? Mesmo quando você dá um grande passo, o PyStart salva todos os estados intermediários do programa, que podem ser refeitos depois que você dá o passo para trás.)

Se você deseja acessar uma parte específica do código, pode acelerar o processo colocando o cursor nessa linha e selecionando *Executar → Executar até o cursor*. Isso faz o PyStart dar passos automaticamente até esta linha. Você pode assumir o comando de lá.
