...
from pystart import ui_utils
from pystart.languages import tr
from pystart.plugins.micropython.daplink_flasher import DaplinkFlashingDialog
from pystart.plugins.micropython.esptool_dialog import try_launch_esptool_dialog
from pystart.plugins.micropython.mp_front import (
...
class CircuitPythonProxy(BareMetalMicroPythonProxy):
    ...
    def _get_backend_launcher_path(self) -> str:
        import pystart.plugins.circuitpython.cirpy_back

        return pystart.plugins.circuitpython.cirpy_back.__file__
