...
from pystart import editor_helpers, get_runner, get_workbench, lsp_types
from pystart.codeview import CodeViewText, SyntaxText, get_syntax_options_for_tag
from pystart.editor_helpers import DocuBox, EditorInfoBox
from pystart.languages import tr
from pystart.lsp_types import CompletionItem, CompletionParams, LspResponse, TextDocumentIdentifier
from pystart.misc_utils import running_on_mac_os
from pystart.shell import ShellText
...
class CompletionsBox(EditorInfoBox):
    ...
    def _check_request_details(self) -> None:
        if not self.winfo_ismapped():
            # can happen, see https://github.com/pystart/thonny/issues/2162
            return
