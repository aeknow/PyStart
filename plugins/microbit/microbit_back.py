...
from pystart.plugins.micropython.bare_metal_backend import launch_bare_metal_backend
from pystart.plugins.simplified_micropython.simplified_mp_back import SimplifiedMicroPythonBackend

# Can't use __name__, because it will be "__main__"
logger = getLogger("pystart.plugins.microbit.microbit_back")
