...
from pystart import get_shell, get_pystart_user_dir, get_workbench
from pystart.common import InlineResponse, MessageFromBackend, ToplevelResponse
from pystart.languages import tr
from pystart.misc_utils import get_menu_char
from pystart.shell import ShellView
from pystart.workbench import WorkbenchEvent
...
def get_log_dir():
    return os.path.join(get_pystart_user_dir(), "user_logs")
