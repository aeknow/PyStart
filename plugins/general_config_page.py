...
from pystart import get_workbench, languages
...
from pystart.misc_utils import running_on_linux
from pystart.ui_utils import get_last_grid_row
...
class GeneralConfigurationPage(ConfigurationPage):
    def __init__(self, master):
        ...
        add_option_checkbox(
            self, "general.single_instance", tr("Allow only single PyStart instance")
        )
        ...
        add_text_row(
            self,
            tr("NB! Restart PyStart after changing these options!"),
