...
from pystart.config_ui import add_label_and_text, add_label_and_url, add_vertical_separator
from pystart.languages import tr
from pystart.misc_utils import running_on_windows
...
class EV3MicroPythonProxy(SshMicroPythonProxy):
    def _get_launcher_with_args(self):
        import pystart.plugins.ev3.ev3_back
        ...
        cmd = [
            pystart.plugins.ev3.ev3_back.__file__,
            repr(args),
        ]
        return cmd
