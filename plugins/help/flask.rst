...
but this may intimidate some beginners. PyStart tries make things easeir and allows running Flask programs
...
Details
-------
PyStart will start the development server approximately like this:
...
``threaded=False`` is used because PyStart's debugger supports only single-threaded programs,
...
In this case PyStart won't add anything to your code.
