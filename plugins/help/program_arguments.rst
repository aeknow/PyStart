...
When you are editing *my_program.py* and press F5, PyStart constructs a magic command 
``%Run my_program.py`` and sends it to the shell, which asks PyStart's back-end to run
that script.
