...
==============================
PyStart has two options for installing 3rd party libraries.
...
.. NOTE::
   ...
   Allowing PyStart to open a shell on the host system would circumvent these protections.
...
================================
Python distribution coming with PyStart doesn't contain scientific programming libraries 
...
them with pip but in case you have troubles, you could try using PyStart with separate 
...
In PyStart open "Tools" menu and select "Options...". In the options dialog open "Interpreter" 
