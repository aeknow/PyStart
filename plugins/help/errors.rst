...
-------------------------------------
Error messages in PyStart have link(s)
...
some parts of the message with the linked place in code. Sometimes PyStart's Assistant can explain 
...
---------------------------------------
See `the page about debugging <debugging.rst>`_ or `the page about using PyStart's debuggers <debuggers.rst>`_.
