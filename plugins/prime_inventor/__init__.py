from pystart.plugins.micropython import (
    BareMetalMicroPythonConfigPage,
    BareMetalMicroPythonProxy,
    add_micropython_backend,
)
from pystart.plugins.micropython.mp_front import VIDS_PIDS_TO_AVOID_IN_GENERIC_BACKEND
...
class PrimeInventorMicroPythonProxy(BareMetalMicroPythonProxy):
    ...
    def _get_backend_launcher_path(self) -> str:
        import pystart.plugins.prime_inventor.prime_inventor_back

        return pystart.plugins.prime_inventor.prime_inventor_back.__file__
...
class PrimeInventorMicroPythonConfigPage(BareMetalMicroPythonConfigPage):
    ...
    def _get_intro_url(self):
        return "https://github.com/pystart/thonny/wiki/InventorPrime"
