...
from pystart import codeview, get_workbench, ui_utils
from pystart.custom_notebook import CustomNotebook
from pystart.editors import BaseEditor
...
from pystart.plugins.event_logging import EventsInputOutputFileError, format_time_range
from pystart.shell import BaseShellText
from pystart.tktextext import TextFrame, TweakableText
...
class Replayer(tk.Toplevel):
    ...
    def cmd_export(self, event=None):
        from pystart.plugins.event_logging import save_events_to_file
    ...
    def create_sessions_mapping(self) -> Dict[str, Tuple[str, time.struct_time, time.struct_time]]:
        from pystart.plugins import event_logging
        from pystart.plugins.event_logging import get_log_dir, parse_file_name
    ...
    def select_session_from_combobox(self, event: Optional[tk.Event] = None) -> None:
        from pystart.plugins.event_logging import load_events_from_file
