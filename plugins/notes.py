...
from pystart import get_pystart_user_dir, get_workbench, ui_utils
from pystart.languages import tr
from pystart.tktextext import EnhancedText, TextFrame
from pystart.ui_utils import TextMenu
...
class NotesView(TextFrame):
    def __init__(self, master):
        self.filename = os.path.join(get_pystart_user_dir(), "user_notes.txt")
        super().__init__(
        ...
        if not os.path.isfile(self.filename):
            self.text.insert(
                ...
                tr(
                    ...
                    + "and loaded when you open PyStart next time.\n\n"
