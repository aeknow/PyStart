...
from pystart import get_workbench, tktextext, ui_utils
from pystart.codeview import CodeView
from pystart.config_ui import ConfigurationPage
from pystart.languages import tr
from pystart.shell import BaseShellText
from pystart.ui_utils import create_string_var
...
class ThemeAndFontConfigurationPage(ConfigurationPage):
    ...
    def _init_previews(self):
        ...
        ttk.Label(
            self,
            text=tr("NB! Some style elements change only after restarting PyStart!"),
