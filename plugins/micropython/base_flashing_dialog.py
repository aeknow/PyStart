...
from pystart.common import UserError
from pystart.languages import tr
from pystart.misc_utils import download_and_parse_json, download_bytes
from pystart.ui_utils import AdvancedLabel, MappingCombobox, set_text_if_different
...
class BaseFlashingDialog(WorkDialog, ABC):
    ...
    def start_work(self):
        from pystart.plugins.micropython import BareMetalMicroPythonProxy
