...
from pystart import get_runner, get_shell, get_workbench, ui_utils
...
from pystart.misc_utils import running_on_mac_os, running_on_windows, sizeof_fmt
from pystart.running import InlineCommandDialog, construct_cd_command
from pystart.ui_utils import lookup_style_option
...
def load_plugin() -> None:
    ...
    for ext in [
        ...
        get_workbench().set_default(get_file_handler_conf_key(ext), "pystart")
