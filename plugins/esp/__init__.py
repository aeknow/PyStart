...
from pystart.plugins.micropython import BareMetalMicroPythonConfigPage, BareMetalMicroPythonProxy
from pystart.plugins.micropython.esptool_dialog import try_launch_esptool_dialog

# from pystart.plugins.micropython.esptool_dialog import try_launch_esptool_dialog
from pystart.plugins.micropython.mp_front import add_micropython_backend, get_uart_adapter_vids_pids
from pystart.plugins.micropython.uf2dialog import show_uf2_installer
...
class ESP8266Proxy(ESPProxy):
    ...
    def _get_backend_launcher_path(self) -> str:
        import pystart.plugins.esp.esp8266_back

        return pystart.plugins.esp.esp8266_back.__file__
...
class ESP32Proxy(ESPProxy):
    ...
    def _get_backend_launcher_path(self) -> str:
        import pystart.plugins.esp.esp32_back

        return pystart.plugins.esp.esp32_back.__file__
